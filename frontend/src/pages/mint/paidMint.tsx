...
export default async function PaidMint(user_address: string, ensName: string, uri: string): Promise<string | null> {
    ...
    try {
        ...
        const { request } = await publicClient.simulateContract({
            ...
            abi: parseAbi(['function registerWithFee(address, bytes32, string)']),
            functionName: 'registerWithFee',
