  ...
  return (
    <div className="mx-auto flex h-screen w-[80%] flex-col items-center justify-center gap-10">
      <div className="rounded-2xl bg-gradient-to-b from-[#F4BC8D] to-[#FFE6B7] p-px">
        <div className="relative flex h-[200px] w-[300px] items-end justify-center rounded-2xl bg-white p-1">
          <Image
            src={megabyte}
            alt="loader"
            width={100}
          ...
          <div className="mb-5 flex flex-col items-center justify-center gap-2">
            ...
            <button
              ...
              className="helvetica relative rounded-2xl bg-gradient-to-b from-[#F4BC8D] to-[#FFE6B7] px-10 py-2"
            >
              Mint .cit
            </button>
          </div>
